;(function(window) {
  ...
  var svgSprite = '<svg>' +
    ...
    '' +
    '<path d="M158.3 699.1c9.8 9.8 25.7 9.8 35.5 0l318.8-318.8 317.2 317.2c9.8 9.7 25.6 9.7 35.4 0 9.7-9.8 9.7-25.6 0-35.4L530.3 327.3c-4.9-4.9-11.4-7.3-17.8-7.3-6.5 0-12.9 2.4-17.9 7.3L158.3 663.6C148.6 673.4 148.6 689.3 158.3 699.1L158.3 699.1zM158.3 699.1"  ></path>' +
    '' +
    '</symbol>' +
    '' +
    '<symbol id="icon-shangla1" viewBox="0 0 1024 1024">' +
    '' +
    '<path d="M865.7 324.9c-9.8-9.8-25.7-9.8-35.5 0l-318.8 318.8-317.2-317.2c-9.8-9.7-25.6-9.7-35.401 0-9.7 9.8-9.7 25.6 0 35.401l334.9 334.8c4.9 4.9 11.4 7.3 17.8 7.299 6.5 0 12.9-2.4 17.9-7.3l336.3-336.3c9.7-9.8 9.7-25.701 0-35.5v0zM865.7 324.9z"  ></path>' +
    '' +
    '</symbol>' +
    '' +
    '</svg>'
